...
public class PropertyReader {
    ...
    */
    ...
    /*
    // following main method is only to test if provided keys are read  from property file or not.
    // main method here is not required.
    public static void main(String[] args) {
        System.out.println(getInstance().getProperty("baseUrl")); // provide key here
    }*/
}
